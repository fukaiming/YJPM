...
class OperationAction extends LoginAfterAction{
  ...
  public function oneoperation(){
    ...
    case DEVICE_MAINTAIN://设备维护
      $this->redirect('OperDeviceManage/deviceMaintain');
    case DEVICE_PURCHASE://设备采购
      $this->redirect('OperDeviceManage/buyDevice');
    case DEVICE_ALLOT://设备调拨
      $this->redirect('OperDeviceManage/deviceAllot');
    case DEVICE_USED_RESOURCE://耗用资源
      $this->redirect('OperDeviceManage/usedResource');
    case DEVICE_COST://设备费用
      $this->redirect('OperDeviceManage/deviceCost');
    case DEVICE_MANAGE://设备经营
      $this->redirect('OperDeviceManage/deiveManage');
    case DEVICE_QUERY://设备查询
      $this->redirect('OperDeviceManage/deviceQuery');
      break;
